...
if __name__ == '__main__':
    ...
    initialization = input("Create matrices and remapped rating file if they don't already exist? (yes or no) ")
    ...
    baseline = input("Do you want to run the baseline recommendation? (yes or no) ")
    while baseline != 'yes' and baseline != 'no':
        baseline = input("Do you want to run the baseline recommendation? (yes or no) ")
    if baseline == 'yes':
        sample_type = input("Do you want to run the randomly sampled data, arbitrarily sampled data or both? (r, a, b) ")
    ...
    collab_filt = input("Do you want to run the collaborative filtering recommendation? (yes or no) ")
